...
func TestExcludes(t *testing.T) {
	...
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"region\":{\"$excludes\":\"CA\"}}", beginsWithOutput, t, "Error in testing Excludes")
	}

	beginsWithOutput, err = Excludes("category_id", 232)
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"category_id\":{\"$excludes\":232}}", beginsWithOutput, t, "Error in testing Excludes")
	}

	beginsWithOutput, err = Excludes("price", 101.77)
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"price\":{\"$excludes\":101.77}}", beginsWithOutput, t, "Error in testing Excludes")
	}
...
func TestExcludesAny(t *testing.T) {
	...
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"region\":{\"$excludes_any\":[\"CA\",\"VA\",\"MA\"]}}", beginsWithOutput, t, "Error in testing ExcludesAny")
	}

	beginsWithOutput, err = ExcludesAny("category_id", 232, 342, 232, 20284)
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"category_id\":{\"$excludes_any\":[232,342,232,20284]}}", beginsWithOutput, t, "Error in testing ExcludesAny")
	}

	beginsWithOutput, err = ExcludesAny("price", 101.77, 77.67, 99.009, 67.644)
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"price\":{\"$excludes_any\":[101.77,77.67,99.01,67.64]}}", beginsWithOutput, t, "Error in testing ExcludesAny")
	}
...
func TestGreaterThan(t *testing.T) {
	...
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"rating\":{\"$gt\":7.5}}", beginsWithOutput, t, "Error in testing GreaterThan")
	}
	...
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"rating\":{\"$gt\":9}}", beginsWithOutput, t, "Error in testing GreaterThan")
	}
	...
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"rating\":{\"$gt\":6.64}}", beginsWithOutput, t, "Error in testing GreaterThan")
	}
...
func TestGreaterThanEqual(t *testing.T) {
	...
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"rating\":{\"$gte\":7.5}}", beginsWithOutput, t, "Error in testing GreaterThanEqual")
	}
	...
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"rating\":{\"$gte\":9}}", beginsWithOutput, t, "Error in testing GreaterThanEqual")
	}
	...
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"rating\":{\"$gte\":6.64}}", beginsWithOutput, t, "Error in testing GreaterThanEqual")
	}
...
func TestEqualsAnyOf(t *testing.T) {
	...
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"region\":{\"$in\":[\"MA\",\"VT\",\"NH\",\"RI\",\"CT\"]}}", beginsWithOutput, t, "Error in testing EqualsAnyOf")
	}
	...
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"rating\":{\"$in\":[9.21,4.25,6.5,7.29,9.99]}}", beginsWithOutput, t, "Error in testing EqualsAnyOf")
	}
	...
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"rating\":{\"$in\":[4,3,100,34,35,23,66,100]}}", beginsWithOutput, t, "Error in testing EqualsAnyOf")
	}
...
func TestIncludes(t *testing.T) {
	...
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"region\":{\"$includes\":\"MA\"}}", beginsWithOutput, t, "Error in testing Includes")
	}
	...
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"rating\":{\"$includes\":9.21}}", beginsWithOutput, t, "Error in testing Includes")
	}
	...
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"rating\":{\"$includes\":7}}", beginsWithOutput, t, "Error in testing Includes")
	}
...
func TestIncludesAny(t *testing.T) {
	...
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"region\":{\"$includes_any\":[\"MA\",\"VT\",\"NH\",\"RI\",\"CT\"]}}", beginsWithOutput, t, "Error in testing IncludesAny")
	}
	...
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"rating\":{\"$includes_any\":[9.21,4.25,6.5,7.29,9.99]}}", beginsWithOutput, t, "Error in testing IncludesAny")
	}
	...
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"category_id\":{\"$includes_any\":[10,100]}}", beginsWithOutput, t, "Error in testing IncludesAny")
	}
...
func TestLessThan(t *testing.T) {
	...
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"rating\":{\"$lt\":7.5}}", beginsWithOutput, t, "Error in testing LessThan")
	}
	...
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"rating\":{\"$lt\":9}}", beginsWithOutput, t, "Error in testing LessThan")
	}
	...
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"rating\":{\"$lt\":6.64}}", beginsWithOutput, t, "Error in testing LessThan")
	}
...
func TestLessThanEqual(t *testing.T) {
	...
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"rating\":{\"$lte\":7.5}}", beginsWithOutput, t, "Error in testing LessThanEqual")
	}
	...
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"rating\":{\"$lte\":9}}", beginsWithOutput, t, "Error in testing LessThanEqual")
	}
	...
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"rating\":{\"$lte\":6.64}}", beginsWithOutput, t, "Error in testing LessThanEqual")
	}
...
func TestNotBeginsWith(t *testing.T) {
	...
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"city\":{\"$nbw\":\"low\"}}", beginsWithOutput, t, "Error in testing NotBeginsWith")
	}
...
func TestNotBeginsWithAny(t *testing.T) {
	...
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"state\":{\"$nbwin\":[\"mass\",\"cali\",\"flor\"]}}", beginsWithOutput, t, "Error in testing NotBeginsWithAny")
	}
...
func TestNotEqualsTo(t *testing.T) {
	...
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"region\":{\"$neq\":\"CA\"}}", beginsWithOutput, t, "Error in testing NotEqualsTo")
	}

	beginsWithOutput, err = NotEqualTo("category_id", 232)
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"category_id\":{\"$neq\":232}}", beginsWithOutput, t, "Error in testing NotEqualsTo")
	}

	beginsWithOutput, err = NotEqualTo("price", 101.77)
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"price\":{\"$neq\":101.77}}", beginsWithOutput, t, "Error in testing NotEqualsTo")
	}
...
func TestNotEqualAnyOf(t *testing.T) {
	...
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"locality\":{\"$nin\":[\"Los Angeles\",\"Santa Monica\"]}}", beginsWithOutput, t, "Error in testing NotEqualAnyOf")
	}
	...
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"rating\":{\"$nin\":[9.21,4.25,6.5,7.29,9.99]}}", beginsWithOutput, t, "Error in testing NotEqualAnyOf")
	}
	...
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"category_id\":{\"$nin\":[10,100]}}", beginsWithOutput, t, "Error in testing NotEqualAnyOf")
	}
...
func TestSearch(t *testing.T) {
	...
	assertEqual(nil, err, t, "function error was thrown")
	if err == nil {
		assertEqual("{\"name\":{\"$search\":\"Charles\"}}", beginsWithOutput, t, "Error in testing Search")
	}
